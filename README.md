...
### Background:
A previous study on faceoffs in the NHL has shown that faceoffs can have a notable impact on a teams success over a full season (Schuckers, Pasquali and Curro, 2012). Increasing the faceoff win rate from 50% to 60% is equivalent to 12 goals and two more wins over a season according to their results. They also found that it takes 40.9 faceoff wins in the power play to gain a goal differential and 76.5 faceoff wins during even strength, suggesting it is more important to win a faceoff during a power play.
